                  ...
                  >
                    ...
                    <div className="pl-3.5">
                      ...
                      <p className="text-xs text-[#3a3a44] mt-1">
                        {mod.checklist_done}/{mod.checklist_total}
                      </p>
                    </div>
                  </button>
                );
          ...
          {selectedModule ? (
            <>
              <div className="mb-6">
                <div className="flex items-start justify-between mb-1">
                  ...
                  <span
                    ...
                    style={{
                      color: STATUS_CONFIG[selectedModule.status].color,
                      background: `${STATUS_CONFIG[selectedModule.status].color}1a`,
                    }}
                  >
              ...
              <div className="space-y-2">
                {checklist.length === 0 && (
                  <p className="text-sm text-[#5a5a66] text-center py-8">
                    No checklist items for this module yet.
                  </p>
                )}
                {checklist.map((item) => (
                  <div
