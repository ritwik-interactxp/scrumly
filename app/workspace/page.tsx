        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-xs text-[#3a3a44] mt-2">
              You'll appear here once the owner adds you to a project.
            </p>
          </div>
        ) : (
            ...
            {projects.map((project) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <h2 className="font-medium text-white group-hover:text-[#c5bfff] transition-colors">
                    {project.name}
                  </h2>
                  <span
                ...
                {project.description && (
                  <p className="text-sm text-[#5a5a66] mb-3 line-clamp-2">{project.description}</p>
                )}
